...
export default function Faq() {
    ...
    const columns = [{
        ...
        label: t('title'), accessor: "title", sortable: true, linkId: "id",
    },

        {
            ...
            label: t("action"), accessor: "action", className: "text-center", linkId: "id", btn: true, actions: [{
                name: "editModal", link: "/saas/frontcms/faq/", setModal: setModal,
    ...
    return (<React.Fragment>
        <div className="page-content">
            <Container fluid>
                <BreadCrumb title={t("faq")} pageTitle={t("faq_list")}/>
                <Card>
                    <CardBody>
                        <MyTable
                            columns={columns}
