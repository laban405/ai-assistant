    ...
    return (<React.Fragment>
        ...
        {(navData || []).map((item, key) => {
            return (<React.Fragment key={key}>
                {/* Main Header */}
                {item['isHeader'] ? <li className="menu-title"><span data-key="t-menu">{props.t(item.label)} </span>
                </li> : ((item.subItems ? (<li className="nav-item">
                    <Link
                        onClick={item.click}
                    ...
                    >
                        ...
                        {item.badgeName ? <span className={"badge badge-pill bg-" + item.badgeColor}
                    ...
                    <Collapse
                        ...
                        <ul className="nav nav-sm flex-column test">
                            {/* subItms  */}
                            {item.subItems && ((item.subItems || []).map((subItem, key) => (<React.Fragment key={key}>
                                {!subItem.isChildItem ? (<li className="nav-item">
                                    <Link
...
SidebarContent.propTypes = {
    location: PropTypes.object, t: PropTypes.any,
};
